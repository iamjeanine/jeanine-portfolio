  ...
  },
  {
    ...
    description: (
      <>
        ...
        <p className="mt-3">
          The story stays the same, but every reading can reveal a new set
          of illustrations. Some editions are created by artists. Others
          are generated by code in real time.
        </p>
        <p className="mt-3">
