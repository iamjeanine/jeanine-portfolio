  ...
  },
  {
    ...
    description: (
      <>
        ...
        <p className="mt-3">
          The voice can change too, with narration recorded by a parent,
          grandparent, or even the child.
        </p>
      </>
    ),
    expandables: [
      ...
      {
        // The illustrator-vs-code mechanic moved here out of the
        // description, which now poses the question and leaves the answer
        // to this panel. Keeping both restated the same idea twice on one
        // screen, the redundancy Jeanine flagged across every entry.
        label: 'Build',
        body: 'Readers can choose between illustrator-created editions and editions generated by code. The story stays the same, while the artwork can change every time they return.',
      },
    ],
