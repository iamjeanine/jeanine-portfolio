...
export const PROJECTS: Project[] = [
  {
    ...
    description: "Children ask for the same story a hundred times. Visual Audiobooks starts there. The recording stays the same, and the pictures are drawn new for every listen.\n\nThe first book is The Kids’ Guidebook to the Rock, an original story about a girl visiting her father in a Florida prison after his failed escape.\n\nSome editions are illustrated by artists. Some are generated by code that interprets the story instead of illustrating it. The narration can be recorded by a parent, a grandparent, or the child.\n\nThe prototype opens on a question: how would you like the story? Pick a visual telling or listen another way.\n\nThe cover is a living photocopy. Torn paper and oxide red assemble into a book, then hold still.",
  },
  {
    id: 'static',
    title: 'Static',
