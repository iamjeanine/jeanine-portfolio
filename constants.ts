...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: "Created an original series pitch exploring uncanny phenomena in a quarantined zone, told through survivors' fractured memories. Inspired by Missing 411 disappearances in National Parks. This is one of several mood pieces developed for the QCODE pitch. Visuals and sound added to inspire thinking beyond the audio format. Music, sound effects, and voices created with ElevenLabs.",
