...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: "Uncanny phenomena in a quarantined exclusion zone, told through survivors' fractured memories. One of several mood pieces created as part of a full series pitch to QCODE.\n\nVoices, music, and sound effects generated using ElevenLabs. Packaged with visuals and video so the pitch reads with film and TV potential, not only audio.",
  ...
  },
  {
    ...
    description: "Two-minute split-screen sequence from VEO3. The scene extender couldn't sustain continuity for that length, so I stitched 18 clips by using each ending frame to prompt the next. Creates the effect of a single continuous shot. (Link: <a href=\"https://www.youtube.com/watch?v=-VUlz4VmdRU\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"underline hover:text-[#2C4A3C] transition-colors\">See annotated breakdown</a> )",
